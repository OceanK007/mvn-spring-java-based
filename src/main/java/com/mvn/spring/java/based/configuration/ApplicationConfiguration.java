package com.mvn.spring.java.based.configuration;
...
@ComponentScan(basePackages="com.maven.spring")	/** Equivalent to: <context:component-scan base-package="com.spring" /> **/
